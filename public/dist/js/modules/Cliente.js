const Cliente = (function () {
  const _formIdPrincipal = "#form-cliente-principal";
  const _formId = "#clienteForm";
  const _tableId = "#clienteTable";
  const _tableTdClass = "clienteTableTd";
  const _modalId = "#clienteModal";
  ...
  function __add() {
    $.loadmask();
    ModalFactory.create("clienteModal", "xl");
  ...
  function __save() {
    ...
    var url = id ? "/admin/clientes/" + id : "/admin/clientes";
  ...
  function __delete() {
    Notify.confirm(
      ...
      function () {
        $.ajax({
          type: "DELETE",
          url: "/admin/clientes/" + $("#id", _formId).val(),
          dataType: "json",
          timeout: 120000,
          success: function (json) {
