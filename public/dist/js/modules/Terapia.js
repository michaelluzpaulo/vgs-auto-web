const Terapia = (function () {
  const _formIdPrincipal = "#form-terapia-principal";
  const _formId = "#terapiaForm";
  const _tableId = "#terapiaTable";
  const _tableTdClass = "terapiaTableTd";
  const _modalId = "#terapiaModal";
  ...
  function __add() {
    $.loadmask();
    ModalFactory.create("terapiaModal", "xl");

    $(".modal-content", _modalId).load(
      "/admin/terapias/create",
  ...
  function __save() {
    ...
    var url = id ? "/admin/terapias/" + id : "/admin/terapias";
      ...
      success: function (json) {
        ...
        if (json.error == 0) {
          ...
          if (file.value != "") {
            ...
            $.ajax({
              url: "/admin/terapias/" + json.data.id + "/foto",
              type: "POST",
              data: formData,
              dataType: "json",
              processData: false,
  ...
  function __delete() {
    Notify.confirm(
      ...
      function () {
        $.ajax({
          type: "DELETE",
          url: "/admin/terapias/" + $("#id", _formId).val(),
          dataType: "json",
          timeout: 120000,
          success: function (json) {
