const Depoimento = (function () {
  const _formIdPrincipal = "#form-depoimento-principal";
  const _formId = "#depoimentoForm";
  const _tableId = "#depoimentoTable";
  const _tableTdClass = "depoimentoTableTd";
  const _modalId = "#depoimentoModal";
  ...
  function __add() {
    $.loadmask();
    ModalFactory.create("depoimentoModal", "lg");

    $(".modal-content", _modalId).load(
      "/admin/depoimentos/create",
  ...
  function __save() {
    ...
    var url = id ? "/admin/depoimentos/" + id : "/admin/depoimentos";
  ...
  function __delete() {
    Notify.confirm(
      ...
      function () {
        $.ajax({
          type: "DELETE",
          url: "/admin/depoimentos/" + $("#id", _formId).val(),
          dataType: "json",
          timeout: 120000,
          success: function (json) {
