const Cupom = (function () {
  const _formIdPrincipal = "#form-cupom-principal";
  const _formId = "#cupomForm";
  const _tableId = "#cupomTable";
  const _tableTdClass = "cupomTableTd";
  const _modalId = "#cupomModal";
  ...
  function __createTable() {
    $(_tableId).dataTable({
      ...
      fnServerParams: function (aoData) {
        ...
        aoData["search[codigo]"] = $("#filtro_codigo").val();
  ...
  function __add() {
    $.loadmask();
    ModalFactory.create("cupomModal", "xl");
  ...
  function __save() {
    ...
    var url = id ? "/admin/cupom/" + id : "/admin/cupom";
  ...
  function __delete() {
    Notify.confirm(
      ...
      function () {
        $.ajax({
          type: "DELETE",
          url: "/admin/cupom/" + $("#id", _formId).val(),
          dataType: "json",
          timeout: 120000,
          success: function (json) {
