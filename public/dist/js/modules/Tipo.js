const Tipo = (function () {
  const _formIdPrincipal = "#form-tipo-principal";
  const _formId = "#tipoForm";
  const _tableId = "#tipoTable";
  const _tableTdClass = "tipoTableTd";
  const _modalId = "#tipoModal";
  ...
  function __add() {
    $.loadmask();
    ModalFactory.create("tipoModal", "lg");
  ...
  function __save() {
    ...
    var url = id ? "/admin/tipos/" + id : "/admin/tipos";
  ...
  function __delete() {
    Notify.confirm(
      ...
      function () {
        $.ajax({
          type: "DELETE",
          url: "/admin/tipos/" + $("#id", _formId).val(),
          dataType: "json",
          timeout: 120000,
          success: function (json) {
