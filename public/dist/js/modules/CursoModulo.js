const CursoModulo = (function () {
  const _formIdPrincipal = "#form-cursomodulo-principal";
  const _formId = "#cursomoduloForm";
  const _tableId = "#cursomoduloTable";
  const _tableTdClass = "cursomoduloTableTd";
  const _modalId = "#cursomoduloModal";
  ...
  function __add() {
    $.loadmask();
    ModalFactory.create("cursomoduloModal", "xl");

    $(".modal-content", _modalId).load(
      "/admin/cursos-modulos/create",
  ...
  function __save() {
    ...
    var url = id ? "/admin/cursos-modulos/" + id : "/admin/cursos-modulos";
  ...
  function __delete() {
    Notify.confirm(
      ...
      function () {
        $.ajax({
          type: "DELETE",
          url: "/admin/cursos-modulos/" + $("#id", _formId).val(),
          dataType: "json",
          timeout: 120000,
          success: function (json) {
