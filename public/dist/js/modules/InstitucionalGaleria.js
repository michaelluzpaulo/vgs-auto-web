var InstitucionalGaleria = (function () {
  var _formId = "#institucionalForm";
  var _modalId = "#institucionalModal";
  ...
  function __displayImagesUpload() {
    ...
    _imagesArrayUpload.forEach((image, index) => {
      images += `<div class="image">
              ...
              <span onclick="InstitucionalGaleria.deleteImageUpload(${index})">&times;</span>
            </div>`;
    });
  ...
  function __deleteGalleryFoto(fotoId) {
    ...
    Notify.confirm(
      ...
      function () {
        $.ajax({
          type: "DELETE",
          url: "/admin/institucionais/" + id + "/galeria-foto/" + fotoId,
          dataType: "json",
          timeout: 120000,
          success: function (json) {
            ...
            setTimeout(() => {
              Institucional.update(json.data.id);
            }, 1500);
          },
