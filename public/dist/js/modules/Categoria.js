const Categoria = (function () {
  const _formIdPrincipal = "#form-categoria-principal";
  const _formId = "#categoriaForm";
  const _tableId = "#categoriaTable";
  const _tableTdClass = "categoriaTableTd";
  const _modalId = "#categoriaModal";
  ...
  function __add() {
    $.loadmask();
    ModalFactory.create("categoriaModal", "lg");
  ...
  function __save() {
    ...
    var url = id ? "/admin/categorias/" + id : "/admin/categorias";
  ...
  function __delete() {
    Notify.confirm(
      ...
      function () {
        $.ajax({
          type: "DELETE",
          url: "/admin/categorias/" + $("#id", _formId).val(),
          dataType: "json",
          timeout: 120000,
          success: function (json) {
