                                ...
                                <tbody>
                                    <?php if($fotos && count($fotos) > 0): ?>
                                        <?php $__currentLoopData = $fotos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr class="institucionalFotoTable_tr-<?php echo e($f->id); ?>">
                                                <td style="text-align:center;vertical-align: middle">
                                                    <a target="_blank"
                                                        href="/storage/institucional/big_<?php echo e($f->img); ?>">
                                                        <img alt="<?php echo e($f->legenda); ?>" title="<?php echo e($f->legenda); ?>"
                                                            src="/storage/institucional/tmb_<?php echo e($f->img); ?>"
...
<?php /**PATH D:\work\www\vgs carros\vgs-auto-web\Modules/Institucional\Resources/views/edit.blade.php ENDPATH**/ ?>