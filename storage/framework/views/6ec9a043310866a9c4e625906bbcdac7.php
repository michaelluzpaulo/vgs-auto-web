...
<?php $__env->startSection('js'); ?>
    ...
    <script type="text/javascript" src="/dist/js/modules/Banner.js?v=<?php echo time(); ?>"></script>
...
<?php $__env->startSection('module_title'); ?>
    <h1><small>Cadastros /</small> Banners</h1>
<?php $__env->stopSection(); ?>
    ...
    <section class="content">
        <div class="card card-secondary card-outline">
            <div class="card-header">
                ...
                <form name="form-banner-principal" id="form-banner-principal">
                    <div class="row">
                        <div class="col-lg-2">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="table-responsive">
                            <table id="bannerTable" class="table table-striped dataTable table-bordered" cellspacing="0"
                                width="100%">
                                <thead>
                                    <tr>
                                        <th>ID</th>
...
<?php echo $__env->make('admin::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Volumes/work/www/vgs_auto_group/vgs_auto/Modules/Banner/Resources/views/index.blade.php ENDPATH**/ ?>