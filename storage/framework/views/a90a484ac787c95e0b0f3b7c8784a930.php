                                            ...
                                            <tr class="carroFotoTable_tr-<?php echo e($f->id); ?>">
                                                <td class="text-center" style="vertical-align: middle;">
                                                    <input type="checkbox" name="carro_foto[]"
                                                        value="<?php echo e($f->id); ?>" class="carro-multifotos-img">
                                                </td>
...
<?php /**PATH /Volumes/work/www/vgs_auto_group/vgs_auto/Modules/Carro/Resources/views/edit.blade.php ENDPATH**/ ?>