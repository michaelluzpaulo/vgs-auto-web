...
<body class="sidebar-mini layout-fixed">
    <div class="wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-1 mt-2">
                        <div class="col-sm-6">
                            <?php echo $__env->yieldContent('module_title'); ?>
                        </div>
                    </div>
                </div>
            </section>
        ...
        <footer class="main-footer d-flex align-content-center justify-content-between">
            ...
            <div>Copyright &copy;
                <?php echo date('Y'); ?> <strong><?php echo e(env('APP_NAME')); ?></strong>
            </div>
        </footer>
...
<?php /**PATH /Volumes/work/www/vgs_auto_group/vgs_auto/Modules/Admin/Resources/views/layouts/master.blade.php ENDPATH**/ ?>