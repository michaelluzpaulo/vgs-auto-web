...
namespace Modules\Categoria\Repositories;
 ...
 */
class CategoriaRepository extends AbstractRepository implements RepositoryInterface
{
  ...
  public function findAll(array $query_params): array
  {
    ...
    $select = DB::table('categoria AS I')
      ->selectRaw("I.*");
