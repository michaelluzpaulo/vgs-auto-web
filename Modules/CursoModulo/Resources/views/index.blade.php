...
@section('js')
    ...
    <script type="text/javascript" src="/dist/js/modules/CursoModulo.js?v=<?php echo time(); ?>"></script>
...
@section('module_title')
    <h1><small>Cadastros / Cursos /</small> Módulos</h1>
@endsection
    ...
    <section class="content">
        <div class="card card-secondary card-outline">
            <div class="card-header">
                ...
                <form name="form-cursomodulo-principal" id="form-cursomodulo-principal">
                    <div class="row">
                        <div class="col-lg-2">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="table-responsive">
                            <table id="cursomoduloTable" class="table table-striped dataTable table-bordered"
