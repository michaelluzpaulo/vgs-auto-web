 ...
 */
class InstitucionalFotoRepository extends AbstractRepository implements RepositoryInterface
{

  protected $table = "institucional_foto";
  protected $fillable = ['legenda', 'img', 'institucional_id'];
