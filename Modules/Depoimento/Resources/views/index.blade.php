...
@section('js')
    <script type="text/javascript" src="/dist/js/modules/Depoimento.js?v=<?php echo time(); ?>"></script>
...
@section('module_title')
    <h1><small>Cadastros /</small> Depoimentos</h1>
@endsection
    ...
    <section class="content">
        <div class="card card-secondary card-outline">
            <div class="card-header">
                ...
                <form name="form-depoimento-principal" id="form-depoimento-principal">
                    <div class="row">
                        <div class="col-lg-2">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="table-responsive">
                            <table id="depoimentoTable" class="table table-striped dataTable table-bordered" cellspacing="0"
                                width="100%">
                                <thead>
                                    <tr>
                                        <th>ID</th>
