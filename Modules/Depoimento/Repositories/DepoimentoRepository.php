...
namespace Modules\Depoimento\Repositories;
 ...
 */
class DepoimentoRepository extends AbstractRepository implements RepositoryInterface
{
  ...
  public function findAll(array $query_params): array
  {
    ...
    $select = DB::table('depoimento AS I')
      ->selectRaw("I.*");
    ...
    foreach ($result as $row) {
      $data[] = ['DT_RowId' => $row->id, $row->id, $row->nome];
    }
