      ...
      <div class="accordion" id="accordion-interacoes">
        ...
        <div class="accordion-item">
          <h2 class="accordion-header">
            <button class="accordion-button accordion_title" type="button" data-bs-toggle="collapse" data-bs-target="#accordion-interacoes-{{ $i->id }}" aria-expanded="false" aria-controls="accordion-interacoes-{{ $i->id }}">
              <svg xmlns="http://www.w3.org/2000/svg" style="margin-right: 12px;" width="14" height="14" fill="#c4c4c4" class="bi bi-plus-circle-fill" viewBox="0 0 16 16">
          ...
          <div id="accordion-interacoes-{{ $i->id }}" class="accordion-collapse collapse" data-bs-parent="#accordion-interacoes">
