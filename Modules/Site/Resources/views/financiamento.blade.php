                        ...
                        <div class="paceiros">
                            ...
                            <div class="d-flex flex-wrap d-flex justify-content-between align-items-center py-4">
                                <a href="https://www.c6bank.com.br/" target="_blank"><img src="/dist/img/logo-c6.jpg"
                                        class="logo-parceiros" alt="logo banco santander"></a>
                    ...
                    <div class="row">
                        ...
                        {{-- <div class="col-lg-12">
                            <div class="text-center mt-2">
                                <button class="g-recaptcha btn g-btn-ver-todos"
                                    data-sitekey="6LfOaIAqAAAAAG5_4BvflGRcUaVigfOPVictBkUe" data-callback='onSubmit'
                                    data-action='submit'>
                                    Enviar
                                </button>
                            </div>
