 ...
 */
class CarroFotoRepository extends AbstractRepository implements RepositoryInterface
{

  protected $table = "carro_foto";
  protected $fillable = ['legenda', 'img', 'carro_id', 'destaque', 'ordem'];
