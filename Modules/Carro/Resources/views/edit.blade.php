            ...
            <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab"
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="categoria_id" id="categoria_id" required>
                                ...
                                @foreach ($categorias as $cat)
                                    <option value="{{ $cat->id }}" <?php echo $carro->categoria_id == $cat->id ? 'selected' : ''; ?>>{{ $cat->nome }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <?php if($carro->img){ ?>
                        <br />
                        <a href="{{ asset("storage/carro/big_{$carro->img}") }}" target="_blank"><img
                                class="img-responsive pad" src="{{ asset("storage/carro/tmb_{$carro->img}") }}"
                                alt="Foto"></a>
                        <?php }?>
                    </div>
                </div>
